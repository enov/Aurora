...
class Aurora_Aurora_Decorator
{
	...
	/**
	 *
	 * @var Interface_Aurora the vanilla Aurora class we're decorating
	 */
	protected $aurora;
	/**
	...
	public function __construct($aurora)
	{
		// if $aurora is an object
		if (!is_object($aurora))
		{
			$classname = Aurora_Type::aurora($aurora);
			$aurora = new $classname;
		}

		// save it to a local var
		$this->aurora = $aurora;
	}
